...
str_count(whole_text, pattern = "Big Brother|big brother|BIG BROTHER")

#OR 

str_count(whole_text, pattern = "(?i)Big Brother")
...
# If you find yourself dealing with variable casing in this way, it might be easier to use the regex() helper function.
...
all_winston_redacted <- str_replace_all(whole_text, pattern, replacement = "Peter")



str_count(all_winston_redacted, "Peter")
#32



# GIVEN ANSWER - REMEMBER TO LOOK FOR ALL CASES e.g. [wW]
...
str_count(whole_text, "gin")


replace_gin_pattern <- "(?i)gin"
replace_gin <- str_replace_all(whole_text, replace_gin_pattern, replacement = "Vodka")

replace_gin



# I can't get this fully.... I changed all gins to Vodka but there are a few gins in lower case, VICTORY GIN and then "gin" also exists in other words like sagging.. so sagging now says "sagVodkag" 
# trying to use the (?i) as well but it just printed "FREEDOM (?i)Vodka" etc. 
# 
...
pattern <- "Department"
str_count(whole_text, "Department")
#there are 3

departments_renamed_section <- str_replace_all(whole_text, pattern, replacement = "Section")
str_count(departments_renamed_section, "Section")
# Yay, there are 3


# NOTE there are "ministries" and "ministry"
str_count(departments_renamed_section, "Ministries|Ministry")
# there are 12

pattern1 <- "Ministries"
pattern2 <- "Ministry"
replacement1 <- "Departments"
replacement2 <- "Department"
ministries_renamed_departments <- str_replace_all(departments_renamed_section, (c(pattern1 = replacement1, pattern2 = replacement2)))
str_count(ministries_renamed_departments, "Department|Departments")

# nope, now I am getting 0  
...
if you want to search for e.g. is there gin in words like sagging...

```{r}

whole_text %>% 
  str_extract_all("(?i)(Department|Ministry|Ministries|Mini[a-z]+)")

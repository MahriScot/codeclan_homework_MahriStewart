...
# prob_of_5_6_or_7 <- four_dice_56or7 %>%
#   tabyl(X1, X2, X3, X4) %>%
#   adorn_totals(where = c("row", "col")) %>%
#   adorn_percentages(denominator = "all") %>%
#   adorn_title(col_name = "Is the total 5 6 or 7")
# prob_of_5_6_or_7

prob_5_6_or_7 <- four_dice_56or7 %>%
...
#Here, the assumptions I have applied is that order matters and so repeats are 
# allowed
```

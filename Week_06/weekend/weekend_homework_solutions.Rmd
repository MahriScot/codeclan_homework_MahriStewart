...
We need to create a new `is_domesticated` variable for the analysis. Also want to drop the NAs because we can't say whether these are domesticated or not, we don't have the information. 
...
**Words**  
$H_0$: the proportion of the town population who are aware of the shop is $40\%$ (or lower)  
$H_a$: the proportion of the town population who are aware of the shop is greater than $40\%$  
...
<details>
<summary>**Answer**</summary>
We would only want to change the page if the CTR for the new banner position was significantly higher than the CTR for the usual banner position.  
...
<details>
<summary>**Answer**</summary>
Would want to know whether the mean width differs significantly from $145\textrm{mm}$, whether it be larger or smaller.   

**Test**  
One-sample mean test, two-sided.  

**Words**  
$H_0$: the mean width of the parts produced that week equals $145\textrm{mm}$  
$H_a$: the mean width of the parts produced that week differs from $145\textrm{mm}$  
...
<details>
<summary>**Answer**</summary>
We fail to reject $H_0$. Based on our sample, we do not have strong enough evidence to conclude that the average width of the manufactured car parts differs from $145\textrm{mm}$. 
</details>
<br>
